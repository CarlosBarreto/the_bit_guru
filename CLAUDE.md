# Instrucciones para Claude — bit_guru
...
- No edites archivos en `frontend-astro/src/` ni `frontend-astro/tests/` directamente
...
- Cambios fuera de `frontend-astro/src/` y `frontend-astro/tests/` (docs, configuración,
