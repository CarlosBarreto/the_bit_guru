...
# Agente Líder (Orquestador) — bit_guru
...
> "Investiga cómo se serializan los IDs en `frontend-astro/src/<modulo>`. Escribe tus
...
nunca verás su contenido en chat — solo una referencia.
...
- Editar archivos en `frontend-astro/src/` o `frontend-astro/tests/`.
