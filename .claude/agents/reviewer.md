...
3. Para cada archivo modificado:
   ...
   - ¿Tiene su test correspondiente en `frontend-astro/tests/`?
4. Ejecuta `.\init.ps1`. Tiene que terminar verde.
...
- C1: [x]
- C2: [x]
- C3: [ ]  ← Razón: frontend-astro/src/<archivo> viola "<regla>"
- C4: [x]
- C5: [x]
